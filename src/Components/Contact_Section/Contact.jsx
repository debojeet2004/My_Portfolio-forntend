...
function Contact() {
    return (
        <div id='connect'  className=' lg:p-[2.5rem] xl:p-[3rem] h-[50rem]  flex flex-col justify-center gap-6 items-center '>
            <div className=" font-[NIKEA] text-[1.4rem]  lg:text-[1.8rem] xl:text-[2.2rem] 2xl:text-[2.8rem]  text-center overflow-scroll xl:overflow-hidden hide_scrollbar group">
