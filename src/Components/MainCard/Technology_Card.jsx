function Technology_Card({text, img}) {
    return (
        ...
        >
            ...
            <img style={{transform: "translateZ(2rem)",transformStyle: "preserve-3d"}}  src={img} className='md:grayscale group-hover:grayscale-0 w-[1.6rem] h-[1.6rem] lg:w-[3rem] lg:h-[2.6rem] hidden md:inline-block' />
